...
if max(abs(constrainedpaths(2Y:100Y).y1.data-endogenousvariables(2Y:100Y).y1.data))>1e-12
   error('Constraint on y1 path is not satisfied!')
end

if max(abs(constrainedpaths(2Y:100Y).y2.data-endogenousvariables(2Y:100Y).y2.data))>1e-12
   error('Constraint on y2 path is not satisfied!')
end

if max(abs(constrainedpaths(2Y:100Y).y3.data-endogenousvariables(2Y:100Y).y3.data))>1e-12
   error('Constraint on y3 path is not satisfied!')
end

if max(abs(exogenousvariables(2Y:100Y).u1.data-SimulatedData(2Y:100Y).u1.data))>1e-12
   error('Constraint on u1 path is not satisfied!')
end

if max(abs(exogenousvariables(2Y:100Y).u2.data-SimulatedData(2Y:100Y).u2.data))>1e-12
   error('Constraint on u2 path is not satisfied!')
end

if max(abs(exogenousvariables(2Y:100Y).u3.data-SimulatedData(2Y:100Y).u3.data))>1e-12
