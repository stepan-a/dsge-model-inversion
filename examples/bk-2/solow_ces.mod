...
SimulatedData = [SimulatedData, dseries(TrueData.exo_simul, 1Y, cellstr(M_.exo_names))];
...
exogenousvariables = dseries([NaN(100, 1), TrueData.exo_simul(1:100,2)], 1Y, cellstr(M_.exo_names));
